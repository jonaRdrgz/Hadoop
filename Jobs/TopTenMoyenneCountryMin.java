package topTenMoyenneCountryMin;
...
public class TopTenMoyenneCountryMin extends Configured implements Tool
{
   //Map class
   ...
   public static class ReduceClass extends Reducer <Text,Text,Text,Text>
   {
      ...
      public void reduce(Text key, Iterable <Text> values, Context context) throws IOException, InterruptedException
      {
         ...
         if(counterAverageTemperature != 0){
            ...
            //Save into TreeMap
            topTenAverageTemperature.put(maxAverageTemperature, key + "");
            if(topTenAverageTemperature.size()>top){
               topTenAverageTemperature.remove(topTenAverageTemperature.lastKey());
            }
         }
         ...
         if(counterTemperatureAverageMax != 0){
            ...
            if(topTenTemperatureAverageMax.size()>top){
               topTenTemperatureAverageMax.remove(topTenTemperatureAverageMax.lastKey());
            }
         }
         ...
         if(counterTemperatureAverageMin != 0){
            ...
            if(topTenTemperatureAverageMin.size()>top){
               topTenTemperatureAverageMin.remove(topTenTemperatureAverageMin.lastKey());
            }
         }
         ...
         if(counterRainPrecipitation != 0){
            ...
            if(topTenRainPrecipitation.size()>top){
               topTenRainPrecipitation.remove(topTenRainPrecipitation.lastKey());
            }
         }
         ...
         if(counterWindSpeed != 0){
            ...
            if(topTenWindSpeed.size()>top){
               topTenWindSpeed.remove(topTenWindSpeed.lastKey());
            }
         }
         ...
         if(counterDaysRain != 0){
            ...
            if(topTenDaysRain.size()>top){
               topTenDaysRain.remove(topTenDaysRain.lastKey());
            }
         }
         ...
         if(counterDaysSnow != 0){
            ...
            if(topTenDaysSnow.size()>top){
               topTenDaysSnow.remove(topTenDaysSnow.lastKey());
            }
         }
         ...
         if(counterDaysStorm != 0){
            ...
            if(topTenDaysStorm.size()>top){
               topTenDaysStorm.remove(topTenDaysStorm.lastKey());
            }
         }
         if(counterFoggyDays != 0){
            ...
            if(topTenFoggyDays.size()>top){
               topTenFoggyDays.remove(topTenFoggyDays.lastKey());
            }
         }
         if(counterDaysTornado != 0){
            ...
            if(topTenDaysTornado.size()>top){
               topTenDaysTornado.remove(topTenDaysTornado.lastKey());
            }
         }
         if(counterHailDay != 0){
            ...
            if(topTenDaysHail.size()>top){
               topTenDaysHail.remove(topTenDaysHail.lastKey());
            }
         }
      }
      ...
      protected String getTopFromMap(TreeMap<Float, String> mapTree){
            ...
            while(iterator.hasNext()) {
               ...
               topCountry = topCountry +","+  (String)mentry.getValue()+ ";"+ key ;
            }
            return topCountry;
      }
   }
   ...
   public int run(String[] arg) throws Exception
   {
      ...
      Job job = new Job(conf, "TopTenMoyenneCountryMin");
      job.setJarByClass(TopTenMoyenneCountryMin.class);
   ...
   {
      int res = ToolRunner.run(new Configuration(), new TopTenMoyenneCountryMin(),ar);
      System.exit(0);
   }
}